...
/// <summary>
/// Credit Notes for GST-compliant document amendments
/// Used when reducing invoice amount (returns, discounts, errors)
/// </summary>
public class CreditNote
{
    ...
    [Required]
    [MaxLength(50)]
    public string CreditNoteNumber { get; set; } = string.Empty; // Format: INV-001-CN-01
    ...
    [Required]
    [MaxLength(1000)]
    public string Reason { get; set; } = string.Empty; // "Return of goods", "Discount adjustment", etc.
